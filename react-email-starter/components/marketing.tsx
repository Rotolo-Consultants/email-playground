import { Html, Head, Preview, Body, Container, Section, Row, Column, Heading, Text, Link, Img, Tailwind } from "@react-email/components";
                ...
                <Container className="bg-white rounded-[8px] mx-auto max-w-[900px] overflow-hidden p-0">
                    ...
                    <Section className="mb-[24px]">
                        <Row className="border-separate [border-spacing:12px] table-fixed w-full">
                            {[
                                {
                                    imageUrl: 'https://react.email/static/coffee-bean-storage.jpg',
